...
def print_div(res):
    ...
    print("Type: ",type(res))
    print("Length of Index 0: ",len(index0))
    print("Type of Index 0: ",type(index0))
    for ind in index0:
        print("===========================================")
        print(len(ind))
...
frame1='test_images/IMG_5064.JPG'
# Run inference on an image
results = model1('test_images/IMG_5064.JPG')  # results list
#results2 = model2('test_images/IMG_5064.JPG')
results3 = model1.track(frame1, persist=True)
